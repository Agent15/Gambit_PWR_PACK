...
namespace Gambonanza.JunksGambit
{
    ...
    public sealed class JunksGambitBuild : IMod
    {
        ...
        public static System.Random pick = new();
        ...
        public static string[] descriptions = {
            ...
            "When an enemy piece moves onto a <sprite=3> <color=◊>TRAP TILE</color>, it gets <color=◊>TRAPPED</color>.",
            ...
            "Buying a <sprite=10> <color=^>QUEEN</color> in the shop grants a <sprite=10> <color=^>QUEEN</color>.",
            ...
            "<color=µ>WAITING</color> skips the player's turn.",
        ...
        // This method overwrites that file at the index "junk_description"
        // Credit to Bentrd for laying the groundwork in GambitRegistry
        public static void UpdateJunkDescription()
        {
            ...
            gambitNode[$"junk_description"] = descriptions[pick.Next(descriptions.Length)];
        }  
    }
}
